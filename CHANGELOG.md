...
- Kept the configuration version, recording-file snapshot context version, and new project format version at `1`; complete `v0.2.x-mc26.10` archives remain compatible and require no conversion.
